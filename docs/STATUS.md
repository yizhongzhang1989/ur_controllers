...
_Last updated: 2026-04-25 (**fortieth consecutive blocker-only
...
_Note: this is now the **fortieth** consecutive no-progress iteration.
...
This is the fortieth consecutive iteration with this same
...
- **[M6.0 gate — still active, 40th iteration]** Decide how to vendor
