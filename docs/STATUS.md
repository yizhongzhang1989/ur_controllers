...
_Last updated: 2026-04-25 (**eighth consecutive blocker-only STATUS
...
docs-only edit. The prior full-gate run (unit 1522 + colcon 10
...
This is the eighth consecutive iteration with this same conclusion;
...
- **[M6.0 gate — still active, 8th iteration]** Decide how to vendor
