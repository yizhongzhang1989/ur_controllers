...
SimpleJointImpedanceController::on_configure(const rclcpp_lifecycle::State& /*previous_state*/) {
    params_ = param_listener_->get_params();
...
controller_interface::CallbackReturn
SimpleJointImpedanceController::on_activate(const rclcpp_lifecycle::State& /*previous_state*/) {
    const std::size_t n = params_.joints.size();
...
controller_interface::CallbackReturn
SimpleJointImpedanceController::on_deactivate(const rclcpp_lifecycle::State& /*previous_state*/) {
...
SimpleJointImpedanceController::update(const rclcpp::Time& time,
...
PLUGINLIB_EXPORT_CLASS(simple_joint_impedance_controller::SimpleJointImpedanceController,
